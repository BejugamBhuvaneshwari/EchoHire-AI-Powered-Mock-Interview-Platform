<div align="center">
  ...
  <h3 align="center">EchoHire: A job interview preparation platform powered by Vapi AI Voice agents</h3>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS and using Vapi's voice agents, EchoHire is a website project designed to help you learn integrating AI models with your apps. The platform offers a sleek and modern experience for job interview preparation.
...
prompt: `
        ...
        Please score the candidate from 0 to 5 in the following areas. Use whole numbers or decimals up to one decimal place. Do not add categories other than the ones provided:
        ...
        {feedback?.categoryScores?.map((category, index) => (
          <div key={index}>
            <p className="font-bold">
              {index + 1}. {category.name} ({category.score}/5)
            </p>
